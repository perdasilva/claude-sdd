...
- Gaps, contradictions, or stale references
- Feasibility issues or technical inaccuracies
- Redundant or misnumbered items

Use the AskUserQuestion tool if there are any fixes you've detected that have multiple valid options for resolution. Apply straightforward fixes directly.
